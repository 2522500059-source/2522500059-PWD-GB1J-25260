<?php
 ...
 /*
  Ambil nilai cid dari GET dan lakukamm validasi untuk 
  mengecek cid harus angka dan lebih besar dari 0  (> 0).
  'options' => ['min_range' => 1] artinya cid harus >_ 1
  (bukan 0, bahkan bukan negatif, bukam huruf, bukan HTML).
  */
...
kemudian validasi dilakukan secara terpisah, sehinnga 
rawan lupa validasi. Untuk input dari $_GET atau $_POST,
