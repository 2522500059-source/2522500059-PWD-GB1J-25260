...
#ambil dan bersihkan (sanitasi) nilai dari form
  ...
  $ortua         = bersihkan($_POST['nama_ortu'] ?? ''); 
  ...
  $stmt = mysqli_prepare($conn, "UPDATE tbl_biodata_pengunjung
                                SET cnim = ?, akode_pengunjung = ?, anama_pengunjung = ?, aalamat_rumah = ?, ahobi = ?, aasal_SLTA = ?, apekerjaan = ?, anama_ortu = ?, anama_pacar = ?, anama_mantan = ? 
                                WHERE cid = ?");
  if (!$stmt) {
